...
function SECMENT:CreateWindow(WindowSettings)
	...
	tween(MainFrame, {BackgroundTransparency = 0, Size = UDim2.fromOffset(920, 560)}, 0.35, Enum.EasingStyle.Quart)
	...
	function Window:CreateHomeTab(HomeSettings)
		...
		local function makeTile(width, mlColor, label, title, sub)
		...
		makeTile(280, SECMENT.MLGradient[1], "Client", tostring(ExecutorName), "Your executor is running Secment UI.")
		makeTile(280, SECMENT.MLGradient[2], "Community", "Join the Discord", "Updates, support, and shared configs.")
		makeTile(272, SECMENT.MLGradient[3], "Session", "Active", "No detections this session.")
